...
export default function FormConnection() {
  ...
  const [packageType, setPackageType] = useState<"residential" | "corporate">(
    "residential",
  );
        ...
        <div className="request-form-body" style={{ padding: "48px 0px" }}>
            ...
            <div className="connection-type-deck">
              <div
                className={`connection-type ${
                  packageType === "residential" ? "active-connection-type" : ""
                }`}
                onClick={() => {
              ...
              <div
                className={`connection-type ${
                  packageType === "corporate" ? "active-connection-type" : ""
                }`}
                onClick={() => {
          ...
          <div className="form-group">
            ...
            <select
              ...
              onChange={(e) =>
                setSelectedPkg(
                  filteredPackages.find((p) => p._id === e.target.value) ||
                    null,
                )
              }
            >
